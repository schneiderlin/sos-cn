...
<!-- VISUALIZATION: physical-attributes type="grouped-bar" data="race-physical-attributes" -->

| 种族 | 体重 | 速度 | 健康 | 加速 | 耐寒 | 耐热 |
|------|------|------|------|------|------|------|
| 阿戈诺什人 | 160.0 | 2.0 | 3.0 | 0.75 | 0.0 | 0.5 |
| 坎特巨人 | 5.0 | 1.1 | 10.0 | 0.75 | 0.7 | -0.1 |
| 克里托尼亚人 | 0.9 | - | - | - | -0.25 | 0.0 |
| 邓多里安人 | 1.1 | - | - | - | 0.25 | -0.25 |
| 贾尔蒂米人 | 0.7 | 1.4 | - | - | -0.25 | 0.15 |
| 人类 | - | - | - | - | -0.15 | -0.15 |
| 阿美伟亚人 | 1.25 | - | - | - | -0.4 | 0.3 |
| 蒂拉皮人 | 0.7 | 1.4 | - | - | -0.1 | -0.1 |
...
<!-- VISUALIZATION: test-marker type="radar-chart" data="race-core-attributes" -->

| 种族 | 体重 | 健康 | 速度 | 加速 | 寿命 | 饥饿 |
|------|------|------|------|------|------|------|
| 阿戈诺什 | +160 | 3x | 2x | 0.75x | 5x | 2x |
| 克里托尼亚 | ... | ... | ... | ... | ... | ... |
...
#### 数值加成
- `is-mul=true`：乘法加成，显示为 "Nx"（如 3.0 → 3x）
- `is-mul=false`：加法加成，显示为 "+N"（如 160.0 → +160）
